...
int main ()
{
    ...
    coord lever1     = {-360, 568};

    coord bucket     =  {-345, 580};
...
void DrawBucket (coord bucket)
{
    txPie           (bucket.x - 25, bucket.y - 25, bucket.x + 25, bucket.y + 25, alphaDeg, 180);
}
